...
select radweg_id, f.bezeichnung strassenname, b.bezeichnung radweg_art, c.bezeichnung richtung, d.bezeichnung oberflaeche, e.bezeichnung quelle, id_in_quelle, breite, geometrie from radverkehr.o_radweg a
